...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/huangcheng/UserCenterModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'huangcheng' => '530539505@qq.com' }
  s.source           = { :git => 'https://github.com/huangcheng/UserCenterModule.git', :tag => s.version.to_s }
